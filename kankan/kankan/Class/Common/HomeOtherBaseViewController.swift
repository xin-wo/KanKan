//
//  HomeOtherBaseViewController.swift
//  kankan
//
...
class HomeOtherBaseViewController: UIViewController, WXCollectionViewProtocol {
...
extension HomeOtherBaseViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
